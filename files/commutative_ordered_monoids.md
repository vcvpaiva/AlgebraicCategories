...
## Definition
A ***commutative ordered monoid*** is an [(totally) ordered monoid]((totally)_ordered_monoids.md) $\mathbf{A}=\langle A,\cdot,1,\le\rangle$ such that
...
## Superclasses
  [Ordered monoids](ordered_monoids.md) supervariety
