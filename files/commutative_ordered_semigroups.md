...
## Definition
A ***commutative ordered semigroups*** is an [ordered semigroup](ordered_semigroups.md) $\mathbf{A}=\langle A,\cdot,\le\rangle$ such that
...
## Subclasses
  [Commutative ordered monoids](commutative_ordered_monoids.md) expansion


## Superclasses
  [Ordered semigroups](ordered_semigroups.md) supervariety
