...
Abbreviation: **Mag**
## Definition
A ***magma*** is a structure $\mathbf{A}=\langle A,\cdot\rangle$ where
$\cdot$ is any binary operation on $A$.

Remark: In Universal Algebra magmas are also called ***groupoids*** or ***binars***. However [groupoid](groupoids.md) now refers to a category in which each morphism is an isomorphism and binar is not as common as magma.

### Morphisms
Let $\mathbf{A}$ and $\mathbf{B}$ be magmas. A morphism from $\mathbf{A}$ to $\mathbf{B}$ is a function $h:A\rightarrow B$ that is a homomorphism: 
...
https://doi.org/10.1090/S0002-9939-1966-0200219-9
