...
## Definition
A ***commutative partially ordered monoid*** is a [partially ordered monoid](partially_ordered_monoids.md) $\mathbf{A}=\langle A,\cdot,1,\le\rangle$ such that
...
## Subclasses
  [Abelian partially ordered groups](abelian_partially_ordered_groups.md) expansion


## Superclasses
  [Partially ordered monoids](partially_ordered_monoids.md) supervariety
