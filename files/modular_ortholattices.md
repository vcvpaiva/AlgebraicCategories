...
## Definition
A ***modular ortholattice*** is an [ortholattice](ortholattices.md) $\mathbf{A}=\langle A,\vee,0,\wedge,1,'\rangle$ such that

the ***modular law*** holds:  $x\le z\Longrightarrow (x\vee y) \wedge z\le x\vee (y\wedge z)$
