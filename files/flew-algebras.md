...
Abbreviation: **FL**$_{ew}$

## Definition
A ***FL***$_{ew}$***-algebra*** is a [FLe-algebra](fle-algebras.md) $\mathbf{A}=\langle A, \vee, \wedge, \cdot, 1, \backslash, /, 0\rangle$ that is
***integral*** (i.e. satisfies the weakening rules): $0\le x\le 1$
