...
## Definition
A ***(nonassociative) algebra*** is a structure $\mathbf{A}=\langle A,+,-,0,\cdot,s_r\ (r\in F)\rangle$ of type $\langle 2,1,0,2,1_r\ (r\in F)\rangle$ such that

$\langle A,+,-,0,s_r\ (r\in F)\rangle$ is a [vector space](vector_spaces.md) over a field $F$

$\cdot$ is ***bilinear***:  $x(y+z)=xy+xz$, $(x+y)z=xz+yz$, and $s_r(xy)=s_r(x)y=xs_r(y)$
