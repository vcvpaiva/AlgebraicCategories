...
## Definition
A ***Banach space*** is a [normed vector space](normed_vector_spaces.md) $\mathbf{A}=\langle A,+,-,0,s_r (r\in F),||\cdot||\rangle$ that is ***complete***:
any Cauchy sequence has a limit.
...
## Superclasses
  [Normed vector spaces](normed_vector_spaces.md) supervariety
