...
<option value="mult">&middot;,1</option>
</select>&nbsp; | &nbsp; Filter by
...
function algebraToString(a,k,n) {
 if (format=="html"){
  ...
  var st="<table style=\"display:inline-block;border: 1px darkgray solid;\"><tr><td colspan=\""+(a.length+1)+"\"><sup>"+n+"</sup>"+"<b>"+classname.slice(0,1)+"</b><sub>"+a.length+","+k+"</sub></td></tr><tr><th>"+(langadd?"+":"&middot;")+"</th>";
