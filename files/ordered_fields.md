...
$\langle F,+,-,0,\cdot,1\rangle$ is a [field](fields.md)

$\langle F,\le\rangle$ is a [linear order](linear_orders.md)
...
## Subclasses
  [Complete ordered fields](complete_ordered_fields.md)


## Superclasses
  [Ordered rings](ordered_rings.md) reduced type

  [Fields](fields.md) reduced type
