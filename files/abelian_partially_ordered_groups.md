...
## Definition
An ***abelian partially ordered group*** is a [partially ordered group](partially_ordered_groups.md) $\mathbf{A}=\langle A,+,-,0,\le\rangle$ such that
...
|Property|Value|
|---|---|
|[Classtype](classtype.md)                        |quasivariety [Lastname19xx]  |
...
## Subclasses
  [Abelian lattice-ordered groups](abelian_lattice-ordered_groups.md) expanded type


## Superclasses
  [Partially ordered groups](partially_ordered_groups.md)

  [Abelian groups](abelian_groups.md) reduced type
