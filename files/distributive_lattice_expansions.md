...
====Definition====
A \emph{distributive lattice expansion} is a structure $\mathbf{A}=\langle A,\vee,\wedge,f:f\in\mathcal F\rangle$ such that

$\langle A,\vee, \wedge\rangle$ is a [[distributive lattice]] and $\langle f:f\in\mathcal F\rangle$ is a
