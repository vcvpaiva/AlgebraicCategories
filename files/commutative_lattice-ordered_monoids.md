...
## Definition
A ***commutative lattice-ordered monoid*** is a [lattice-ordered monoid](lattice-ordered_monoids.md) $\mathbf{A}=\langle A, \vee, \wedge, \cdot, 1\rangle$  such that
...
## Superclasses
  [Lattice-ordered monoids](lattice-ordered_monoids.md) supervariety

  [Commutative monoids](commutative_monoids.md) subreduct

  [Commutative lattice-ordered semigroups](commutative_lattice-ordered_semigroups.md) subreduct
