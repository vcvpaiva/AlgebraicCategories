...
## Definition
An ***associative algebra*** is a [(nonassociative) algebra]((nonassociative)_algebras.md) $\mathbf{A}=\langle A,+,-,0,\cdot,s_r\ (r\in F)\rangle$ where $\mathbf F$ is a [field](fields.md) such that
