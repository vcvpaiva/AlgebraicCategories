...
## Definition
A ***commutative lattice-ordered semigroup*** is a [lattice-ordered semigroup](lattice-ordered_semigroups.md) $\mathbf{A}=\langle A,\vee,\wedge,\cdot\rangle$ such that
...
## Superclasses
  [Lattice-ordered semigroups](lattice-ordered_semigroups.md) supervariety

  [Commutative semigroups](commutative_semigroups.md) subreduct

  [Lattices](lattices.md) subreduct
